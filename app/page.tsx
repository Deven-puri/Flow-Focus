      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Look at any word for 3 seconds, and our AI will explain it. Track your focus patterns and improve your reading comprehension.
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="grid md:grid-cols-3 gap-6 text-left">
            ...
            <div>
              ...
              <h4 className="font-bold text-gray-800 mb-1">Dwell Detection</h4>
              <p className="text-sm text-gray-600">
                Automatic trigger after 3 seconds of focus
              </p>
            </div>
            <div>
              <div className="text-3xl mb-2">🔒</div>
